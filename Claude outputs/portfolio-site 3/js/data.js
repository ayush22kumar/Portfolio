...
/* Career + education timeline, oldest to newest, rendered as an interactive
   horizontal timeline (see initTimeline() in render.js). Each milestone can
   carry a `related` sub-entry for a project/internship/award that sits
