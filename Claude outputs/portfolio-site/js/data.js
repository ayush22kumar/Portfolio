...
const profile = {
  ...
  subtext:
    "Five years across enterprise SaaS, SAP/ERP, and regulated programmes. Most recently, I've been running requirements, delivery, and governance solo on an AI product with no assigned product manager.",
  ...
  cvLink: "AyushKumar_SeniorLeadBusinessAnalyst_CV.pdf", // <-- add your CV file to the repo root and update this
  photo: "assets/photo/ayush-portrait.jpg",
  about:
    "I've spent the last five years as the analyst organisations call on when a programme has no dedicated product owner, no existing governance standard, and no room for ambiguity. Most recently, on a GCP-based AI SaaS product with no assigned product owner, the requirements, backlog, and delivery calls have all run through me, reporting directly to Directors and SLT. Before that, I delivered SAP S/4HANA and ERP transformation across regulated environments (GDPR life-sciences, UK public sector, and Ofgem-governed energy) inside global, multi-country consulting teams. I build the governance artefacts that outlast the programme: a UAT framework now used organisation-wide, an ITIL-aligned change process that still saves 500+ hours a quarter. I'm currently building toward CBAP certification.",
  focusAreas: [
...
const experience = [
  {
    ...
    company: "Activate Group Limited, UK",
    dates: "Feb 2025 – Present",
    bullets: [
      "The only Business Analyst across several concurrent programmes, including a GCP-based AI SaaS product with no assigned product owner, so requirements, backlog, and delivery decisions default to me. I report directly to Directors and SLT.",
      "Used Claude (Anthropic) for discovery and requirements scoping within governed AI-usage guidelines, accelerating early-stage analysis.",
      "Initiated and led an ITIL-aligned change-request process, automating intake via Power Automate and Power Apps, saving 500+ hours/quarter.",
      "Scaled a multi-tenant SaaS platform to 200+ body shops UK-wide, cutting onboarding from 12 to 4 weeks with 80%+ sustained adoption.",
      "Built a reusable UAT framework, now the organisation's governance standard for testing and sign-off.",
    ],
  },
  {
    ...
    bullets: [
      "Owned business analysis concurrently across multiple global client engagements, spanning GDPR life-sciences, UK public-sector, Ofgem/RIIO energy, and state-government programmes in India, within global multi-country teams.",
      "Delivered a UK energy-sector SAP S/4HANA implementation, authoring Ofgem-aligned requirements and using SAP Signavio process mining, cutting clarification rounds 75%.",
      "Led root cause analysis using DMAIC principles, cutting data-quality issues 40% and lifting operational efficiency 18%.",
      "Line managed two junior Business Analysts, coaching them through requirements elicitation to independently deliver further projects.",
    ],
  },
  {
    ...
    bullets: [
      "Deployed automated monitoring across 120 SAP systems, reducing downtime 25%.",
      "Optimised SAP S/4HANA implementations with 0% data loss during migration and a 20% system performance improvement.",
    ],
  },
];
...
const testimonials = [
  {
    ...
    author: "Simon Elliott, Head of Implementation & Change (managed Ayush directly)",
  },
  {
    quote:
    ...
    author: "Maria Cabral, Project Manager (worked with Ayush on the same team)",
  },
  {
    quote:
      "Ayush worked with me as SAP Basis Administrator. He shows great enthusiasm in learning new things. He delivered the activities assigned to him in timely fashion. He is an asset to any team he joins. I wish him great success in all future endeavours!",
    author: "Kumud Singh, CITP MBCS MIET, Enterprise Architect (worked with Ayush on the same team)",
  },
];
